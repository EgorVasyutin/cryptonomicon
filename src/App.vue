  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    ...
    <div class="container">
      ...
      <graph-component
        ...
        @select-ticker-null="selectedTicker = null"
        :graph="graph"
        @graph-null="graph = []"
      />
    </div>
...
export default {
  name: "App",
  components: { AddTicker, GraphComponent },
  ...
  methods: {
    ...
    checkTicker() {
      this.tickers.forEach((t) => {
        this.checkTickers = t.name === this.ticker;
      });
    },
  },
};
